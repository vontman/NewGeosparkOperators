...
object GNNWithPruning_tmp {

  def apply(gridType: GridType, indexType: IndexType): GNNWithPruning_tmp = {
    ...
    new GNNWithPruning_tmp(gridType, indexType)
  }
}

class GNNWithPruning_tmp(gridType: GridType, indexType: IndexType)
    extends GNNSolver {
